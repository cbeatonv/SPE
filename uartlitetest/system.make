...
# \\vboxsvr\desktop\uartlitetest\system.mhs
# The software specification of the system is in file :
# \\vboxsvr\desktop\uartlitetest\system.mss
...
Code_program: $(CYG_CODE_OUTPUT) 

$(CYG_CODE_OUTPUT) : $(CODE_SOURCES) $(CODE_HEADERS) $(CODE_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/code_compiler.opt
	@mkdir -p $(CODE_OUTPUT_DIR) 
	$(CODE_CC) $(CODE_CC_OPT) $(CODE_SOURCES) -o $(CYG_CODE_OUTPUT) \
	$(CODE_OTHER_CC_FLAGS) $(CODE_INCLUDES) $(CODE_LIBPATH) \
	$(CODE_CFLAGS) $(CODE_LFLAGS) 
	$(CODE_CC_SIZE) $(CYG_CODE_OUTPUT) 
	@echo ""
